...
col_names <- str_squish(col_names)
...
for(file in file_list){
  ...
  for(sheet in sheet_list){
    ...
    colnames(CEMonthly_raw) <- str_squish(colnames(CEMonthly_raw))
    ...
    df <- rbind(df,CEMonthly_raw)
    processed_sheet <- c(processed_sheet,sheet)
  }
